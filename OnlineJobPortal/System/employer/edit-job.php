...
<head>
	...
	<title>Online Job Portal - <?php echo "$jobtitle"; ?></title>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Online Job Portal is a job portal, online job management system developed by Bwire C Mashauri in february 2018.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Online Job Portal Contact</h5>
