					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> UET - VNU, <br/> Cau Giay, <br/>Hanoi</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:20020000@vnu.edu.vn">20020000@vnu.edu.vn</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+233 546 607 474">+84 123 456 789</a>
								</li>
								...
								<li>
										...
										<div class="contact-social">
											...
											<a href="<?php echo "https://www.facebook.com/"; ?>" data-toggle="tooltip" data-placement="top" title="Facebook"><i class="fa fa-facebook"></i></a>
											<a href="<?php echo "https://twitter.com/"; ?>" data-toggle="tooltip" data-placement="top" title="Twitter"><i class="fa fa-twitter"></i></a>
											<a href="<?php echo "https://www.instagram.com/"; ?>" data-toggle="tooltip" data-placement="top" title="Instagram"><i class="fa fa-instagram"></i></a>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="mailto:20020000@vnu.edu.vn">20020000@vnu.edu.vn</a></p>
