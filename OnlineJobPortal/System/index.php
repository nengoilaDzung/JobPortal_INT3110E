		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url();">
				<div class="container">
					...
					<h1>Find your next jobs here</h1>
					...
					<div class="main-search-form-wrapper">
						...
						<form action="job-list.php" method="GET" autocomplete="off">
							...
							<div class="form-holder">
								<div class="row gap-0">
									...
									<div class="col-xss-6 col-xs-6 col-sm-6">
										<input placeholder="Search categories here" class="form-control" name="category" required/>
										 <?php
							...
							<div class="btn-holder" >
								<button name="search" value="✓" type="submit" class="btn index-search" ><i class="" style="font-style:normal;" >Search</i></button>
							</div>
					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<div class="section-title">
								...
								<br><h2 style="text-transform:capitalize;">Companies</h2>
